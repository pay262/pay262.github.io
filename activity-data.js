...
// 201. 农行省钱月卡·支付宝立减金
{
    ...
    startTime: "2026-09-01",
    endTime: "2026-09-30",
    desc: "农行掌银用户可通过首页下拉进入掌银助手，发送'省钱月卡'参与活动。支付0.01元或0.5元可购5元支付宝立减金（含3张1元+1张2元，共5元）。立减金需在农行APP-我的-礼券中手动领取至支付宝，有效期至2026年10月7日，限农行借记卡使用。部分用户反馈可多次参与（微信/支付宝/美团各一次）",
    ...
    remark: "限农行借记卡用户；路径：农行APP首页下拉→掌银助手→发送'省钱月卡'；立减金需手动领取至支付宝；名额有限先到先得；不同用户支付金额可能不同（0.01元或0.5元）",
    canShare: false
},
// 202. 四川农行瓜分百万礼金
{
...
// ============================================================
//  新增活动 203（上海电信天翼云电脑精英版减免促销）
//  来源：用户提供截图 + 上海电信资费专区
//  编号从 203 开始
// ============================================================

// 203. 上海电信天翼云电脑精英版减免促销（可叠加）
{
    id: 203,
    operator: "电信",
    province: "上海市",
    ...
    mainType: "其他活动",
    subType: ["老用户专享"],
    title: "上海电信天翼云电脑精英版减免促销·叠加后0元/月",
    startTime: "2026-09-02",
    endTime: "2026-12-31",
    desc: "上海电信用户拨打02110000客服，要求叠加'天翼云电脑精英版减免促销'（方案编号：26SH100206），可减免158元/月云电脑月费，实现0元/月使用天翼云电脑精英版（8核16G/50M带宽）。减免促销立即生效，订购当月按天减免[reference:0]。需先订购天翼云电脑精英版（原价158元/月）后再叠加该减免促销[reference:1]。叠加后还可额外享受校园话补促销（充99元送261元，合计360元分12个月返还）",
...
// ============================================================
//  新增活动 210（广东移动10分满意翻翻乐）
//  来源：用户提供截图 + 中国移动活动页面
//  编号从 210 开始
// ============================================================

// 210. 广东移动10分满意翻翻乐·瓜分60万份话费流量
{
    id: 210,
    operator: "移动",
    province: "广东省",
    ...
    mainType: "其他活动",
    subType: ["抽奖活动"],
    title: "广东移动10分满意翻翻乐·瓜分60万份话费流量",
    startTime: "2026-09-02",
    endTime: "2026-09-30",
    desc: "广东移动客户进入活动页面点击“汪汪卡片”即可参与随机抽奖，奖品含5元话费券（2万份）、5GB流量券（38万份，有效期3天）、2GB流量券（20万份，有效期3天）。同一客户活动期间最终只能获得奖品一次，奖品有限先到先得，话费券或流量券将在24小时内到达中国移动APP卡券中心",
    remark: "限广东移动客户；同一客户活动期间最终只能获得1次奖品；奖品先到先得；获奖后24小时内到账中国移动APP卡券中心",
    link: "https://wx.10086.cn/qwhdhub/flipcard/1026082124?A_C_CODE=OBYzs3dRq7&token=QWHDSSOD20260903T173857667DU1026082124HtxsqgR954228",
    canShare: false
},
// ============================================================
//  新增活动 211（广东联通“抽抽乐”幸运大抽奖）
//  来源：用户提供截图 + 25xianbao.com
//  编号从 211 开始
// ============================================================

// 211. 广东联通“抽抽乐”幸运大抽奖·充50送50话费券
{
    id: 211,
    operator: "联通",
    province: "广东省",
    ...
    mainType: "其他活动",
    subType: ["抽奖活动"],
    title: "广东联通“抽抽乐”·充50送50话费券",
    startTime: "2024-08-10",
    endTime: "2026-12-31",
    desc: "广东联通用户每月可参与1次抽奖，奖品为“飞享充值优惠券”（充50送50、充30送30、充100送100等档位）。预存款立即到账，赠款分3/5/10个月返还，每月10元，赠款当月有效。中奖后需当月内完成兑换，超期不予补赠",
    remark: "限广东联通手机用户（不含全国流量王8元套餐、副卡、达量限速用户）；每月限1次；中奖后当月内需完成兑换；抽奖入口：https://u.10010.cn/uAbfh 或联通APP-老用户专区",
    link: "https://u.10010.cn/uAbfh",
    canShare: false
},
// ============================================================
//  新增活动 212（湖南电信“长期福利久伴有礼”）
//  来源：用户提供截图 + 湖南电信活动页面
//  编号从 212 开始
// ============================================================

// 212. 湖南电信“长期福利久伴有礼”·在网越久福利越升级
{
    id: 212,
    operator: "电信",
    province: "湖南省",
    ...
    mainType: "会员权益类",
    subType: ["赠送流量", "生活权益"],
    title: "湖南电信“长期福利久伴有礼”·在网越久福利越升级",
    startTime: "2026-08-21",
    endTime: "2026-11-30",
    desc: "湖南电信用户订购15元/月权益产品（生活随心选权益包/互联网畅享权益包），根据在网时长享受阶段性升级福利：①满2个月起，连续4个月每月可领5GB流量（满2个月当月额外领3元话费券）；②满6个月起，连续6个月可领10GB流量或5元话费券（二选一）。15元档产品订购6个月以上可享月费降至10元或流量从5GB升至15GB",
    remark: "限湖南电信用户；需订购15元档权益产品后方可参与；福利需每月主动领取，逾期视为放弃；退订后福利终止，重新订购在网时长清零；话费及流量仅限当月使用，不可结转",
    link: "https://qy.hn.189.cn/h5app/equity/#/long-term-gift?channel=gyptlqzq",
    canShare: false
},
// ============================================================
//  新增活动 213-215（湖南电信权益活动）
//  来源：湖南电信活动页面
//  编号从 213 开始
// ============================================================
...
// 213. 湖南电信芒果九宫格抽奖
{
    ...
    mainType: "其他活动",
    subType: ["抽奖活动"],
    title: "湖南电信芒果九宫格抽奖·订购权益包抽实物好礼",
    startTime: "2026-09-03",
    endTime: "2026-12-31",
    desc: "湖南电信用户每成功订购1份权益包并领取芒果TV会员，即可获得1次九宫格抽奖机会（可累计），奖品含实物礼品等。参与抽奖需先订购以下权益包之一：互联网畅享权益包（15元/月，10GB通用流量或5GB通用流量+热门权益N选1）；互联网专属权益流量包（30元/月，20GB通用流量+影音/生活/出行/音乐权益N选1）；15GB视频权益聚合定向流量包（19.9元/月，15GB专属流量+影音会员N选1）",
    remark: "限湖南电信用户；需先订购权益包并完成芒果TV会员领取后方可获得抽奖机会；抽奖机会可累计；实物奖品页面仅作部分展示，具体以实际收到为准",
    link: "https://qy.hn.189.cn/h5app/equity/#/mango-wheel?channel=gyptlqzq",
    canShare: false
},
// 214. 湖南电信B站九宫格抽奖
{
    ...
    mainType: "其他活动",
    subType: ["抽奖活动"],
    title: "湖南电信B站九宫格抽奖·订购权益包抽实物好礼",
    startTime: "2026-09-03",
    endTime: "2026-12-31",
    desc: "湖南电信用户每成功订购1份权益包并完成B站会员领取，即可额外获得1次九宫格游戏参与机会。需先订购以下权益包之一：互联网畅享权益包（15元/月，10GB通用流量或5GB通用流量+热门权益N选1）；互联网专属权益流量包（30元/月，20GB通用流量+影音/生活/出行/音乐权益N选1）；15GB视频权益聚合定向流量包（19.9元/月，15GB专属流量+影音会员N选1）",
    remark: "限湖南电信用户；需先订购权益包并完成B站会员领取后方可获得参与机会；实物奖品页面仅作部分展示，具体以实际收到为准",
    link: "https://qy.hn.189.cn/h5app/equity/#/bili-wheel?channel=fllq",
    canShare: false
},
// 215. 湖南电信权益中心·福利聚合页
{
    ...
    mainType: "会员权益类",
    subType: ["领取福利"],
    title: "湖南电信权益中心·福利聚合页",
    startTime: "2026-09-03",
    endTime: "2026-12-31",
    desc: "湖南电信权益中心聚合页，含爆款推荐：久伴有礼（领流量或话费券）、芒着抽大奖（100%中奖）、优惠产品（优选会员+8GB 19.9元/月、生活会员任选9.9元/月、影视会员+20GB流量30元/月）。需登录后查看具体权益",
    remark: "限湖南电信用户；需登录后查看具体权益内容；页面聚合了多款优惠产品及活动入口",
    link: "https://qy.hn.189.cn/h5app/equity/#/entitlement-index",
    canShare: false
},
// ============================================================
//  新增活动 216-218（湖南电信流量加倍/见面礼/5G-A优享包）
//  来源：湖南电信活动页面
//  编号从 216 开始
// ============================================================

// 216. 湖南电信“全家一起用，套外流量赠送”
{
    id: 216,
    operator: "电信",
    province: "湖南省",
    ...
    mainType: "流量类",
    subType: ["赠送流量"],
    title: "湖南电信“全家一起用”·套外流量加倍赠送",
    startTime: "2025-09-12",
    endTime: "2026-12-31",
    desc: "0元/月，入网6个月及以上、5G畅享融合129元及以上套餐用户，每月套餐内活跃号卡≥3张（每张当月主叫≥30分钟或流量≥1GB），次月10日前可获赠套外流量：129元档30GB、169元档40GB、199元档60GB、239元档80GB、299元档100GB、399元档150GB、599元档300GB。订购立即生效，有效期24个月，到期自动续约，退订立即生效",
    remark: "限湖南电信入网6个月及以上、5G畅享融合129元及以上套餐用户；近半年内未办理套餐降档、未有流量溢出且未订购流量包；上月套餐内活跃号卡张数小于3张；达量降速类、时长类套餐用户不适用；获赠流量不可结转，次月10日前到账；主副卡均可订购但每套餐仅生效一次",
    link: "https://waphn.189.cn/selfResource/activity/v2/#/flowDouble?sourceChannel=hndxgzh&",
    canShare: false
},
// 217. 湖南电信“9月见面礼”·抽流量/金豆/翼回收券
{
    id: 217,
    operator: "电信",
    province: "全国",
    ...
    mainType: "其他活动",
    subType: ["抽奖活动"],
    title: "湖南电信“9月见面礼”·抽流量/金豆/翼回收券",
    startTime: "2026-08-01",
    endTime: "2026-08-31",
    desc: "中国电信手机用户登录页面领取『中国电信见面礼』，每个手机号限领一次。奖品含：200MB流量（安徽）、1GB流量（辽宁/河南/江西）、500MB流量（湖南）、3GB流量（新疆/宁夏）、5GB流量（上海）、2GB流量（福建/甘肃）、1GB流量日包（重庆）、200金豆、20元翼回收加价券等，奖品因归属地而异。奖品领取后72小时内未使用自动失效，月末最后一天领取的奖品当天24点过期",
    remark: "限中国电信手机用户；星卡随心版、青年一派用户、小号用户无法参与；流量奖品需跳转至对应页面领取后发放，自然月内每个用户仅能领取一次；话费奖品7个工作日内到账；兑换路径：中国电信APP-我的-我的奖券",
    link: "https://wappark.189.cn/resources/shortMessage/rearendMoneyWap.html?cmpid=null&pageType=&utm_as=gzhcd&utm_af=hn&utm_sdl=&transactionId=3b7513d0-a78a-11f1-a5d8-795b6b49d687&code=W_0000&accessCode=nm217988b739d8498fbf26209d83f23c65&operatorType=CM&expiredTime=1800&number=",
    canShare: false
},
// 218. 湖南电信“5G-A优享包”·20元/月
{
    id: 218,
    operator: "电信",
    province: "湖南省",
    ...
    mainType: "其他活动",
    subType: ["老用户专享"],
    title: "湖南电信“5G-A优享包”·20元/月享5G-A网络权益",
    startTime: "2025-04-24",
    endTime: "2027-04-24",
    desc: "20元/月享5G-A网络权益（网络速率下行最高2Gbps，上行最高300Mbps），订购立即生效，有效期24个月，到期自动续订。需使用支持5G-A网络的终端并接入5G-A网络方可享受权益。退订次月生效，速率权益同步失效，无违约责任",
    remark: "限湖南电信移动用户（天翼畅享达量降速版套餐及已订购达量降速版畅享升级包用户除外）；同一号码不可重复订购；主副卡不可共享，副卡可单独订购；含10G通用流量仅限中国内地使用，可结转；退订方式：线下营业厅或中国电信APP",
    link: "https://flow.hn.189.cn/hnfx/jlb/newllzqSinger?tcid=9310089&clientid=WXHL69&code=071GhsFa1gcVmM0wKHGa17CMS72GhsFx&state=1788434908894",
    canShare: false
},
// ============================================================
//  新增活动 219-221（湖南电信自动充 / 天翼云音乐校园活动）
//  来源：湖南电信 / 天翼云音乐活动页面
//  编号从 219 开始
// ============================================================

// 219. 湖南电信话费自动充·开通享折扣+每月3GB流量
{
    id: 219,
    operator: "电信",
    province: "湖南省",
    ...
    mainType: "话费充值类",
    subType: ["充送话费", "赠送流量"],
    title: "湖南电信话费自动充·开通享折扣+每月3GB流量",
    startTime: "2026-09-03",
    endTime: "2026-12-31",
    desc: "湖南电信用户开通话费自动充值服务（余额低于20元时自动充值），可享充值折扣。2022年后激活的用户签约后即可获赠“电信盲盒”一份（自动开启）。每月赠送3GB流量，首月在开通后48小时内到账，次月起每月1-8日到账。同一号码若开通微信、支付宝、翼支付等多项代扣业务，仅可享受一次流量赠送",
    remark: "限湖南电信用户；开通路径：微信/支付宝搜索“湖南电信话费自动缴费”；扣款金额可设置20/50/100/200/300元；关闭路径：微信-我-服务-钱包-支付设置-自动续费 或 支付宝-我的-设置-支付设置-免密服务/自动扣款",
    link: "https://waphn.189.cn/viteService/daikou?sourceChannel=hndxgzh&operateTag=gzhtw&openId=Bmu2LJj4k9fe7Udd4Aa0bqGWRmprPLWUZR8C1YgxXZVUF1Cj3lYSb%2FFu2sxoWjSU",
    canShare: false
},
// 220. 天翼云音乐“百校乐动玩转AI拼豆”·制作AI作品抽奖
{
    id: 220,
    operator: "电信",
    province: "全国",
    ...
    mainType: "其他活动",
    subType: ["抽奖活动"],
    title: "天翼云音乐“百校乐动玩转AI拼豆”·制作AI作品抽好礼",
    startTime: "2026-08-15",
    endTime: "2026-09-30",
    desc: "全国31省用户（不含港澳台）参与AI制作可抽奖，奖品含拼豆挂饰、积分等。用户每次完成AI制作即可获得1次抽奖机会。电信用户可通过登录获赠2次制作次数，移动/联通/广电用户获赠3次；完成任务可额外获得制作次数。电信已开通视频彩铃用户可将作品直接设置为视频彩铃",
    remark: "限中国电信、移动、联通、广电用户（制作）；抽奖仅限中国电信用户；活动时间2026年8月15日至9月30日；参与路径：天翼智铃小程序/爱音乐APP；电信用户需开通视频彩铃功能方可设置彩铃",
    link: "https://ai.imusic.cn/h5v/fusion/campus-activities-2026?ca=MGjJ&cc=156000009095&Z05Fj22mY0=SSoUlztwDU",
    canShare: false
},
// 221. 湖南电信副卡专区·权益领取
{
    ...
    startTime: "2026-09-03",
    endTime: "2026-12-31",
    desc: "湖南电信副卡用户登录后可领取副卡专属权益，含“副卡立即领卡，包邮到家”等服务。具体权益内容需登录后查看",
    remark: "限湖南电信副卡用户；需登录后查看具体权益；页面提示“普通副卡权益副卡立即领卡，包邮到家”",
    link: "https://waphn.189.cn/viteBusiness/fkzq/index?sourceChannel=hndxgzh&openId=Bmu2LJj4k9fe7Udd4Aa0bqGWRmprPLWUZR8C1YgxXZVUF1Cj3lYSb%2FFu2sxoWjSU",
    canShare: false
},
// ============================================================
//  新增活动 222（湖南电信流量专区·聚合页）
//  来源：湖南电信流量专区
//  编号从 222 开始
// ============================================================

// 222. 湖南电信流量专区·流量包/提速包/权益包聚合页
{
    id: 222,
    operator: "电信",
    province: "湖南省",
    city: "全省",
    mainType: "流量类",
    subType: ["全国通用流量", "定向流量", "闲时流量"],
    title: "湖南电信流量专区·月包/日包/提速包/权益包聚合页",
    startTime: "2026-09-03",
    endTime: "2026-12-31",
    desc: "湖南电信流量专区聚合页，含月包、日包、提速包、当月包、季/年包、权益包、闲时包等多款流量产品，用户可登录后按需办理。页面含新人专享（日限量200份）、爆款推荐等板块",
    remark: "限湖南电信用户；需登录后查看具体产品及价格；页面为流量产品聚合入口，具体规则以各产品详情页为准",
    link: "https://flow.hn.189.cn/hnfx/jlb/newllzq?clientid=WXHL&code=051jFJFa1UbDmM0tfaHa14ZL6n3jFJFD&state=1788435235967",
    canShare: false
},
// ============================================================
//  新增活动 223（农行银联信用卡云闪付首绑赠18元立减券包）
//  来源：中国农业银行官网
//  编号从 223 开始
// ============================================================

// 223. 农行银联信用卡云闪付首绑赠18元立减券包+会员季卡
{
    id: 223,
    operator: "银行",
    province: "全国",
    ...
    mainType: "其他活动",
    subType: ["新用户专享", "支付立减"],
    title: "农行银联信用卡云闪付首绑·赠18元立减券包+会员季卡",
    startTime: "2026-08-07",
    endTime: "2026-09-30",
    desc: "农行62银联信用卡持卡人通过中国农业银行APP或云闪付APP等渠道，首次绑定农行62银联信用卡至云闪付后，即有机会获得18元立减券包（含3张6元立减券）+会员礼遇季卡。立减券在云闪付单笔订单满6.01元可用，有效期90天，每个自然月限使用1张。同一持卡人仅限参与一次，名额有限先到先得",
    remark: "限农行62银联信用卡持卡人；需首次绑定云闪付；立减券可在云闪付APP-我的-优惠券中查看；活动名额有限，先到先得；不含EMV卡、运通卡、万事达全球支付白金卡等",
    link: "https://article.95516.com/eq/ls/J68hgOiW.html",
    canShare: false
},
// ============================================================
//  新增活动 224（移动灵犀口令·秋风送爽来）
//  来源：中国移动APP
//  编号从 224 开始
// ============================================================

// 224. 移动灵犀口令“秋风送爽来”·抽话费加赠券
{
    id: 224,
    operator: "移动",
    province: "全国",
    ...
    mainType: "话费充值类",
    subType: ["充值立减"],
    title: "移动灵犀口令“秋风送爽来”·抽话费加赠券",
    startTime: "2026-09-04",
    endTime: "2026-09-04",
    desc: "中国移动APP底部点击“灵犀”图标，发送口令“秋风送爽来”，即可抽取随机话费加赠券，至高9元。口令仅限9月4日10:00-23:59有效，限量70万份，先到先得[reference:0][reference:1]。卡点（10:00）发送中奖概率更高，容易抽中7元或9元加赠券[reference:2][reference:3]",
    remark: "限中国移动用户；需登录中国移动APP参与；路径：APP底部菜单“灵犀”→输入口令“秋风送爽来”；口令仅限今日有效；每人限参与1次；奖励为随机话费加赠券，需在充值话费时勾选使用",
    link: "",
    canShare: false
},
// ============================================================
//  新增活动 225（湖北电信星卡存费赠费）
//  来源：25xianbao.com + 用户提供信息
//  编号从 225 开始
// ============================================================

// 225. 湖北电信星卡存费赠费·充50得110/充100得220
{
    id: 225,
    operator: "电信",
    province: "湖北省",
    ...
    mainType: "话费充值类",
    subType: ["充送话费"],
    title: "湖北电信星卡存费赠费·充50得110/充100得220",
    startTime: "2026-09-06",
    endTime: "2026-12-31",
    desc: "湖北电信星卡用户参与存费赠费活动：充50元得110元（50元本金即时到账，60元赠费分月返还）；充100元得220元（100元本金通常24小时内到账，120元赠费分月返还，参考同类活动为次月起分12个月每月返10元）。赠送话费仅能抵扣套餐月基本费，不能抵扣国际业务、港澳台业务通信费和SP/CP代收费用[reference:0]",
    remark: "限湖北电信星卡用户，具体以本机打开页面校验为准[reference:1]；赠费分月返还，非一次性到账[reference:2]；合约期内提前注销或退出指定套餐，次月起话费不再赠送[reference:3]；小道消息称年底可能结束[reference:4]；参与路径：湖北电信公众号→充值查询→存费赠费[reference:5]",
    link: "",
    canShare: false
},
// ============================================================
//  新增活动 226（湖北电信云手机0元试用2个月）
//  来源：25xianbao.com + 用户提供信息
//  编号从 226 开始
// ============================================================
...
// 226. 湖北电信云手机0元试用2个月
{
    ...
    mainType: "其他活动",
    subType: ["新用户专享"],
    title: "湖北电信云手机0元试用·白嫖2个月",
    startTime: "2026-09-06",
    endTime: "2026-12-31",
    desc: "湖北电信用户可通过链接开通天翼云手机体验版，0元试用2个月。试用期结束后云手机依旧存在（已订业务-功能产品中显示较长时间有效期），后续可能会被取消但不会被扣费。部分省份地区有效，部分省份到期会直接消失",
    remark: "限湖北电信用户（部分省份可能有效）；试用期2个月；到期后云手机仍存在但可能后续被取消，不会被扣费；属于bug类活动，随时可能失效；参与路径：直接打开链接跳转电信营业厅开通试用",
    link: "https://www.189.cn/wapportalweb/flowcard/flowcard_detail.html?salesid=00000000b578e0f4dbbb11f0a2fbfa163e6607b1",
    canShare: false
},

// ============================================================
//  新增活动 227（北京移动9.9元云电脑·短信办理）
//  来源：25xianbao.com + 用户提供信息
//  编号从 227 开始
// ============================================================

// 227. 北京移动9.9元云电脑·8核16G长期套餐
{
    id: 227,
    operator: "移动",
    province: "北京市",
    ...
    mainType: "其他活动",
    subType: ["老用户专享"],
    title: "北京移动9.9元云电脑·8核16G长期套餐",
    startTime: "2026-09-06",
    endTime: "2026-12-31",
    desc: "北京移动用户发送短信KTYDNZZQY到10086，即可开通家庭云电脑高级版月包，9.9元/月享8核CPU+16G内存+200G数据盘。长期有效，适合远程办公或轻度云游戏。配置性价比极高（原高级版参考价159元/月[reference:2]），目前仅需9.9元/月",
    remark: "限北京移动用户；发送KTYDNZZQY到10086办理；9.9元/月长期有效；配置8核16G+200G数据盘；非北京卡无法办理",
    link: "",
    canShare: false
},
// ============================================================
...
// 229. 寄大大5元寄快递·比价寄件平台
{
    ...
    mainType: "其他活动",
    subType: ["生活权益"],
    title: "寄大大5元寄快递·比价寄件平台",
    startTime: "2026-09-06",
    endTime: "2026-12-31",
    desc: "微信扫码关注“寄大大”公众号，通过菜单栏“寄快递”下单，可享多家快递比价寄件服务。同城1公斤件约4.69-6.01元，跨省首重5元起，比官方原价优惠15%-40%。支持韵达、极兔、申通、圆通、中通、京东、德邦等多家快递公司比价选择",
    remark: "全国可用；微信扫码关注公众号后使用；每日签到可换券包；下单后需主动联系快递员取件；2小时未接单可取消换一家；未产生实际运输可退款",
    link: "https://xf-photo.oss-cn-guangzhou.aliyuncs.com/xifan-oss/oZA2k5JFe0apgm7nNF90Unlo4qWc_779218.jpg",
    canShare: false
},
// ============================================================
//  新增活动 230（移动“流量爽翻”抽奖活动）
//  来源：用户提供截图 + 搜索结果验证
//  编号从 230 开始
// ============================================================

// 230. 移动“流量爽翻”·每月抽流量/话费（四川等地区）
{
    id: 230,
    operator: "移动",
    province: "四川省",
    ...
    mainType: "其他活动",
    subType: ["抽奖活动"],
    title: "移动“流量爽翻”·每月抽最高180GB流量或888元话费",
    startTime: "2026-09-01",
    endTime: "2026-12-31",
    desc: "四川移动用户每月可获1次流量抽奖机会，抽奖可得30GB/60GB/120GB/180GB套后国内通用流量券或话费券（如8.88元）。当月累计使用流量到达指定数值还可额外获得抽奖机会，可抽0.88-888元话费或5-180GB流量包[reference:0][reference:1]。奖品需在有效期内激活使用[reference:2][reference:3]。活动期间每月可获赠1次流量抽奖机会[reference:4]",
    remark: "限四川移动用户（搜索结果多为四川地区）[reference:5]；部分用户反馈其他地区也可尝试[reference:6]；每月1次抽奖机会，当月累计使用流量达标可额外增加次数[reference:7]；流量券为套后国内通用流量[reference:8]；需在有效期内激活使用",
    link: "",
    canShare: false
},
// ============================================================
//  新增活动 231（中信银行社群专属交易达标抽奖）
//  来源：中信银行信用卡中心
//  编号从 231 开始
// ============================================================

// 231. 中信银行社群专属交易达标抽奖·抽还款券/支付立返金
{
    id: 231,
    operator: "银行",
    province: "全国",
    ...
    mainType: "其他活动",
    subType: ["抽奖活动", "支付立减"],
    title: "中信银行社群专属交易达标抽奖·抽还款券/支付立返金",
    startTime: "2026-09-01",
    endTime: "2026-12-31",
    desc: "中信银行信用卡官方企微群客户，完成指定交易达标任务后可获得抽奖机会，奖品含1元/8元/18元/88元/888元还款券、1元/8元支付立返金等。每个客户仅有一次抽奖机会，非100%中奖，奖品随机下发，数量有限抽完即止。中奖后需绑定中信银行信用卡官方微信公众号方可兑换奖品",
    remark: "限中信银行信用卡官方企微群客户（群主为指定客服）；需满足交易达标条件（参考同类活动为月交易额＞6000元）；同一手机、同一微信号视为同一客户；未持有有效信用卡无法发放奖品；活动时间以页面实际展示为准",
    link: "https://mcs.creditcard.ecitic.com/citiccard/frontend/mcs/image/template/html/ctwh52026070800002/ctwh52026070800002.html",
    canShare: false
},
// ============================================================
//  新增活动 232（工商银行“敬师好礼”抽奖）
//  来源：工行手机银行APP
//  编号从 232 开始
// ============================================================

// 232. 工商银行“敬师好礼”抽奖·完成任务赢工银i豆
{
    id: 232,
    operator: "银行",
    province: "全国",
    ...
    mainType: "其他活动",
    subType: ["抽奖活动"],
    title: "工商银行“敬师好礼”抽奖·完成任务赢工银i豆",
    startTime: "2026-09-01",
    endTime: "2026-09-30",
    desc: "登录工行手机银行App，进入“任务中心”或“尊师惠师”专区，完成指定任务（如访问“一键绑卡”栏目、查看“我的账户”、访问“尊师惠师”专区等）即可获得抽奖机会，抽取900-1000工银i豆。在职教师完成身份认证后，更有机会赢取10000工银i豆。工银i豆可在i豆商城兑换微信立减金、实物礼品等权益，活动名额有限先到先得",
    remark: "限工商银行手机银行用户；教师身份认证需为在职教师；奖品数量共计15万份，领完即止；工银i豆可在“工银i豆”商城兑换微信立减金、生活权益等；任务中心入口：工行APP-任务中心；尊师惠师专区：工行APP-尊师惠师教师专区",
...
// ============================================================
//  新增活动 233-234（河北联通组合包）
//  来源：用户提供短信截图 + 线下渠道信息
//  编号从 233 开始
// ============================================================

// 233. 河北联通1元300分钟+40GB组合包
{
    id: 233,
    operator: "联通",
    province: "河北省",
    city: "全省",
    mainType: "号卡套餐类",
    subType: ["老用户套餐", "全国通用流量"],
    title: "河北联通1元300分钟+40GB组合包（长期有效）",
    startTime: "2026-09-09",
    endTime: "2029-12-31",
    desc: "1元/月享300分钟国内语音+40GB国内通用流量。产品立即生效，失效时间2029年12月31日，到期如双方无异议则以三年为周期自动续展。不限套餐、不限网龄，可通过中国联通电话销售渠道或客服热线10010办理",
    remark: "限河北联通用户；办理渠道为联通电话销售渠道（10010外呼）或客服热线；产品编号：26HE300192；资费1元/月；有效期至2029年12月31日，到期自动续展；如需退订可向10010或营业厅咨询",
    link: "",
    canShare: false
},
// 234. 河北联通2元80GB+500分钟永久组合包
{
    id: 234,
    operator: "联通",
    province: "河北省",
    ...
    mainType: "号卡套餐类",
    subType: ["老用户套餐", "全国通用流量"],
    title: "河北联通2元80GB+500分钟永久组合包",
    startTime: "2026-09-10",
    endTime: "2029-12-31",
    desc: "2元/月享80GB国内通用流量+500分钟国内语音，为联通永久包，不限套餐、不限网龄。目前仅限石家庄联通自有营业厅办理，具体以营业厅实际办理为准",
    remark: "限河北联通用户（目前仅限石家庄地区）；办理渠道为石家庄联通自有营业厅；不限套餐、不限网龄；具体办理规则及是否可长期续约以营业厅解释为准",
    link: "",
    canShare: false
},
// ============================================================
...
// ============================================================
//  新增活动 236（湖南电信“秋季畅享礼”0元40G流量包）
//  来源：用户提供截图 + 25xianbao.com
//  编号从 236 开始
// ============================================================

// 236. 湖南电信“秋季畅享礼”·0元40GB通用流量包（12个月）
{
    id: 236,
    operator: "电信",
    province: "湖南省",
    ...
    mainType: "流量类",
    subType: ["赠送流量"],
    title: "湖南电信“秋季畅享礼”·0元40GB通用流量包",
    startTime: "2026-09-09",
    endTime: "2026-09-30",
    desc: "编辑短信2640发送至10001，即可办理0元40GB通用流量包。资费0元/月，流量为国内通用流量（不含港澳台），有效期12个月，到期后号码状态正常将自动续延12个月。流量优先级高于套餐内流量，不可共享、不可结转、每月清零。方案编号：26HN100123",
    remark: "限通过线上渠道入网的湖南互联网卡星卡29元（2022版）/星卡39元（2022版）/星卡流量版（59元）套餐主卡用户；需2026年7月至8月期间漫游至山东、四川、浙江、广西、贵州并有使用记录；号码状态正常，未享受校园类优惠；编辑短信2640发送至10001办理；退订次月生效",
    link: "",
    canShare: false
},
// ============================================================
//  新增活动 237（河南电信9元60G带会员套餐）
//  来源：用户提供线报 + 京东办理链接
//  编号从 237 开始
// ============================================================

// 237. 河南电信9元60G带会员·先试后买
{
    id: 237,
    operator: "电信",
    province: "河南省",
...
// ============================================================
//  更新活动 238（爱奇艺白金联合会员合约·广西移动专属）
//  来源：用户提供截图
//  编号 238（根据补充信息更新）
// ============================================================

// 238. 爱奇艺白金联合会员合约·19.9元/月送100GB流量+通话+话费券
{
    id: 238,
    operator: "移动",
    province: "广西壮族自治区",
    ...
    mainType: "会员权益类",
    subType: ["视频会员", "赠送流量"],
    title: "爱奇艺白金联合会员合约·19.9元/月送100GB流量",
    startTime: "2026-01-07",
    endTime: "2026-12-31",
    desc: "19.9元/月办理爱奇艺白金联合会员合约，含：①爱奇艺白金VIP月卡（解锁40+会员权益，支持手机/PAD/电脑/电视/车载多端使用，2台设备同时播放）；②每月100GB国内通用流量；③每月1000分钟国内通话+500条短信。办理另加赠30元话费券（10元×3张，本月起每月生效一张）",
    remark: "限广西移动用户；仅限中国移动APP、广西移动10086微信公众号等自有线上渠道办理可获赠话费券；话费券需在生效当月前往中国移动APP-我的-卡券手动兑换，逾期无法兑换；活动仅能参与一次，取消产品后重新办理无法获赠话费券；合约期及违约金规则以办理页面为准",
    link: "",
    canShare: false
},
// 239. 广西电信APP服务评价抽话费（必中技巧）
{
    id: 239,
    operator: "电信",
    province: "广西壮族自治区",
    ...
    mainType: "其他活动",
    subType: ["抽奖活动"],
    title: "广西电信APP服务评价抽话费·三次拉满必中",
    startTime: "2026-09-17",
    endTime: "2026-12-31",
    desc: "广西电信用户打开电信APP，搜索“服务评价”进入活动页面，下拉完成2个评价任务（五星评价），返回页面刷新抽奖次数（有1分钟延迟），即可获得抽奖机会。建议将3次抽奖机会全部拉满后再逐一抽取，基本必中话费，话费直接到账余额，无需兑换。如页面无抽奖入口，可尝试搜索“意见反馈”或“我的金豆”进入",
    remark: "限广西电信用户（其他地区可自测）；中奖话费秒到账，无需手动兑换；疑似一个号每月只能中奖一次；抽奖次数有延迟，需等待1分钟刷新；如未显示抽奖入口，可尝试搜索“意见反馈”或“我的金豆”进入",
    link: "",
    canShare: false
},
// ============================================================
...
// 240. 湖南移动“全民百G礼包（网龄版）”·网龄越长赠送越多
{
    ...
    mainType: "流量类",
    subType: ["全国通用流量", "赠送流量"],
    title: "湖南移动“全民百G礼包（网龄版）”·月费10元/15元",
    startTime: "2026-09-19",
    endTime: "2026-12-31",
    desc: "湖南移动推出“全民百G礼包（网龄版）”，根据用户前6个月月均消费及网龄，提供两档选择：①10元档：每月90GB国内通用流量+1000分钟国内语音+500条短信；②15元档：每月200GB国内通用流量+2000分钟国内语音+1000条短信。网龄越长，赠送越多",
    remark: "限湖南移动用户；活动页面显示用户前6个月的月均消费用于判定可办理档位；需通过湖南移动官方线上渠道（掌上营业厅/中国移动APP）办理；具体合约期、生效规则及互斥条件以办理页面实际展示为准；有用户反馈部分号码可能因资格限制无法参与",
    link: "https://wap.hn.10086.cn/h5web/static/activity2026/age/index.html",
    canShare: false
},
// ============================================================
//  新增活动 241（中国移动“冲榜乐消消”）
...
// 241. 中国移动“冲榜乐消消”·消消乐游戏赢话费流量
{
    ...
    mainType: "其他活动",
    subType: ["抽奖活动"],
    title: "中国移动“冲榜乐消消”·消消乐游戏赢话费流量",
    startTime: "2026-09-22",
    endTime: "2026-11-04",
    desc: "中国移动在网用户每日登录可获2次游戏参与机会，完成每日任务可额外增加1次。参与消消乐游戏即有机会获得话费券或流量券，具体奖品以页面实际展示为准。活动每周一9:00开奖，赢至高百元话费。非100%中奖，奖品数量有限先到先得，发完即止",
    remark: "限中国移动在网用户（不含港澳台）；活动时间即日起至2026年11月4日；每周一9:00开奖；每日登录送2次机会，完成任务额外+1次；若在其他渠道已参与同系列活动并领取过相关卡券，则无法重复中奖；需在微信内打开活动链接参与",
    link: "https://wx.10086.cn/qwhdhub/xiaoxiaole/1026072228?A_C_CODE=mTN1pRazog&token=QWHDSSOD20260912T095806940DU1026072228H7q9dqR725505#/",
    canShare: false
},
// ============================================================
//  更新活动 242（中国电信云智手机体验版·0元订购）
//  来源：用户提供链接 + 官方活动页面
//  编号 242（根据完整页面信息更新）
// ============================================================

// 242. 中国电信云智手机体验版·0元享AI智能体服务
{
    id: 242,
    operator: "电信",
    province: "全国",
    ...
    mainType: "会员权益类",
    subType: ["视频会员", "领取福利"],
    title: "中国电信云智手机体验版·0元享AI智能体服务",
    startTime: "2026-09-22",
    endTime: "2026-12-31",
    desc: "0元/月享云智手机体验版，含：①畅享7000余部高清影视+200余款大型手游内容服务；②生活智能体30次对话服务（支持出行打车、点外卖等，开通后72小时内限时使用，仅旗舰模型消耗次数）；③2026年12月31日前首次订购用户限时赠送爱奇艺黄金会员周卡（登录云智手机APP领取，数量有限先到先得）。影音/游戏服务自动开通至次月月底，分两月发放。需在各大应用市场下载云智手机APP使用",
    remark: "限中国电信移动用户；产品由新国脉数字文化股份有限公司提供，客服电话400-8689-689（9:00-21:00）；订购立即生效，用户手机号码生命周期内只能订购一次；主副卡不可共享，副卡可单独订购；与云智手机标准版（销售品编码：7360110000101138）互斥；有效期为2个月（含订购当月），到期自动退订；退订/销户/携转无违约责任；退订路径：中国电信APP-服务大厅-号卡服务-业务退订-加装包退订/线下营业厅/客服10000号；服务内容不含爱奇艺内容、云机空间，需自行开通；生活智能体数据在服务停止7天后清除",
    link: "https://wapmas.189.cn/mas-pub-ui/spm/newActivity/ACTCODE202608174CXX1RK6?activityCode=ACTCODE202608174CXX1RK6&yxai=ACTCODE202608174CXX1RK6",
    canShare: false
},
// ============================================================
//  新增活动 243（中国移动多方通话全国版）
//  来源：用户提供短信截图 + 25xianbao.com
//  编号从 243 开始
// ============================================================

// 243. 中国移动多方通话（全国版）·0元月费开通
{
    id: 243,
    operator: "移动",
    province: "全国",
    ...
    mainType: "其他活动",
    subType: ["老用户专享"],
    title: "中国移动多方通话（全国版）·0元月费开通",
    startTime: "2026-09-22",
    endTime: "2029-12-31",
    desc: "中国移动用户发送短信KTDFTHYW到10086，收到二次确认提醒后10分钟内回复“Y”即可开通多方通话（全国版）。功能费0元/月，使用时由发起方按通话接入数与各接入通话时长合计计收基础语音费，扣费标准与大网基础语音通话保持一致。亲情网、V网用户成员间按群组语音通话优惠标准享受拨打优惠。自生效日期起有效期3年，到期如无异议自动续展，每次续展3年。无合约期，退订/销户/携转无需承担违约责任",
    remark: "限中国移动用户；发送KTDFTHYW到10086办理；收到二次确认后需在10分钟内回复“Y”确认订购；功能费0元/月，通话费按基础语音标准计费；亲情网、V网成员间享拨打优惠；有效期3年，自动续展；无合约期，退订无违约金；业务编号：26JT200570",
    link: "",
    canShare: false
},
// 244. 中国移动周六游戏日·做任务抽话费流量
{
    id: 244,
    operator: "移动",
    province: "全国",
    ...
    mainType: "其他活动",
    subType: ["抽奖活动"],
    title: "中国移动周六游戏日·做任务抽话费流量",
    startTime: "2026-01-01",
    endTime: "2026-12-31",
    desc: "中国移动APP搜索“周六游戏日”进入活动页面，完成浏览任务后返回即可获得抽奖机会，奖品含1元/2元/6元话费券、1GB流量日包等，周六最高可抽666元话费券。每日可参与，不限于周六",
    remark: "需在中国移动APP内参与；入口：APP搜索“周六游戏日”；每日可做任务抽奖，周六奖励升级；部分任务点进去马上返回即可完成",
    link: "https://dx.10086.cn/A/J8uQHg",
    canShare: false
},
// 245. 中国移动周日追剧盛宴·每周日领话费/流量/会员
{
    id: 245,
    operator: "移动",
    province: "全国",
    ...
    mainType: "会员权益类",
    subType: ["视频会员", "赠送流量"],
    title: "中国移动周日追剧盛宴·每周日领话费/流量/会员",
    startTime: "2026-01-01",
    endTime: "2026-12-31",
    desc: "中国移动APP搜索“周日视频日”或“周日追剧盛宴”进入活动页面，含三大板块：①热点视频：爱奇艺会员月卡订购；②幸运抽奖机：完成订阅/任务获福利值，每周日开放抽奖，奖品含2GB流量日包、爱奇艺月卡、5元/100元话费兑换券；③疯狂补给站：每周日12点/16点限时秒抢，1000份/日，奖品为5元话费兑换券、2GB流量日包",
    remark: "需在中国移动APP内参与；入口：APP搜索“周日视频日”；仅限周日开放；福利值月底清零，需及时使用；秒抢每日1000份，先到先得",
    link: "https://wx.10086.cn/hlwyxhdhub/act-sunvideo/index.html#/signup",
    canShare: false
},
// ============================================================
//  新增活动 246（北京移动新业务礼包·0元黄金会员包）
//  来源：用户提供线报 + 25xianbao.com + 搜索验证
//  编号从 246 开始
// ============================================================

// 246. 北京移动新业务礼包·0元享黄金会员（自动续期3年）
{
    id: 246,
    operator: "移动",
    province: "北京市",
    ...
    mainType: "会员权益类",
    subType: ["视频会员", "网盘会员"],
    title: "北京移动新业务礼包·0元享黄金会员",
    startTime: "2026-09-22",
    endTime: "2029-12-31",
    desc: "发送短信KTXYWLB到10086即可办理新业务礼包，0元/月。每月可获得移动云盘500G空间、视频彩铃基础会员包、北京移动Plus黄金会员融合版。黄金会员权益含：①1GB流量日包或30GB定向App流量（二选一）；②视频会员周卡或日卡（可兑换网易云、QQ音乐、腾讯视频、爱奇艺、优酷、芒果TV、B站等主流平台）；③移动云盘500G空间；④视频彩铃基础会员包。自动续期3年，到期无异议自动续展，基本等于长期有效",
    remark: "限北京移动用户；发送KTXYWLB到10086办理；0元/月；自动续期3年，到期无异议自动续展；部分用户反馈Plus黄金会员融合版可能因与已有年礼包互斥而未生效，具体以短信通知为准；合约期内不可取消，到期后需主动退订",
    link: "",
    canShare: false
},
];
